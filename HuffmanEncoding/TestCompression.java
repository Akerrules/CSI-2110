...
public class TestCompression {
	 ...
	 * 
	 * @param args contains commands in 3 types of format: E inputfile outputfile
	 *             Usage example: java TestCompression E genes.txt genes.huf E is
	 *             for encoding inputfile into outputfile D inputfile outputfile
	 *             Usage example: java TestCompression D genes.huf genesRecover.txt
	 *             D is for decoding inputfile into outputfile T testfile Usage
	 *             example: java TestCompression T tests.txt T goes to file that
	 *             contains lines of type E and D one per line we provided
	 *             'tests.txt' with the assignment
	 * 
	 * @throws IOException
	...
	public static void main(String[] args) throws IOException, ClassNotFoundException {
		...
		if (args.length == 0) { // hardcoded and interactive inputs
			...
			myHuff.decode("genes.huf", "genes.txt");
